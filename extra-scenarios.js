...
// 背景先讀模式：先顯示情境背景，按「開始答題」後，每題只顯示題目。
(function () {
  ...
  function initBackgroundFirstFlow() {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initBackgroundFirstFlow);
  } else {
    initBackgroundFirstFlow();
  }
})();
