// /scenarios/scenario-data.js
// 額外情境資料：只放情境內容，不處理畫面、不處理註冊。

window.EXTRA_SCENARIO_TOTAL = 13;

window.extraSituations = {
  teasing: {
    card: {
      icon: '🛡️',
      title: '被同學取笑：保持冷靜',
      desc: '被同學取笑或改花名時，學習保護自己和尋求協助。'
    },
    ...
    game: {
      ...
      avatar: '🛡️',
      role: '被取笑情境',
      mission: '保持安全，清楚表達感受，必要時向老師求助。',
      location: '小息／走廊',
      socialGoal: '保護自己 + 不升級衝突',
      supportTip: '可以用短句表達不舒服，再離開或求助。',
      hint: '不用用同樣方式取笑對方，先保護自己最重要。',
      calmPrompt: '先深呼吸，心裡說：「我可以冷靜處理，唔需要即刻反擊。」',
      steps: [
        {
          prompt: '第 1 題：聽到同學取笑你時，第一步怎樣比較安全？',
          options: [
  ...
  bumped: {
    ...
    game: {
      ...
      avatar: '🚶',
      role: '走廊情境',
      mission: '分辨意外和故意，保持安全並用合適方式表達。',
      location: '走廊／樓梯',
      socialGoal: '情緒控制 + 安全表達',
      supportTip: '先確認自己是否安全，再用短句表達。',
      hint: '被撞到會不開心，但未必代表對方是故意的。',
      calmPrompt: '先站穩，吸一口氣，確認自己有沒有受傷。',
      steps: [
        {
          prompt: '第 1 題：被撞到後，第一步最應該做什麼？',
          options: [
        ...
        {
          prompt: '第 2 題：如果對方說「唔好意思」，你可以怎樣回應？',
          options: [
        ...
        {
          prompt: '第 3 題：如果你不確定對方是否故意，最好怎樣想？',
          options: [
        ...
        {
          prompt: '第 4 題：如果你真的受傷或很害怕，應該怎樣做？',
          options: [
  ...
  disagree: {
    ...
    game: {
      ...
      avatar: '🧠',
      role: '小組分歧情境',
      mission: '學習接受不同意見，並把討論帶回任務。',
      location: '課室／小組活動',
      socialGoal: '彈性思考 + 合作溝通',
      supportTip: '不同意不等於否定你這個人。',
      hint: '可以先表示明白，再問對方原因。',
      calmPrompt: '心裡提醒自己：「佢唔同意我個方法，唔代表佢唔鍾意我。」',
      steps: [
        {
          prompt: '第 1 題：聽到別人不同意時，第一個反應最好是？',
          options: [
        ...
        {
          prompt: '第 3 題：如果對方提出另一個方法，你可以怎樣做？',
          options: [
        ...
        {
          prompt: '第 4 題：如果最後小組沒有用你的方法，你可以怎樣想？',
          options: [
  ...
  teacherReminder: {
    ...
    game: {
      ...
      avatar: '📋',
      role: '課室規則情境',
      mission: '學習接受提醒，修正行為，避免後果升級。',
      location: '課室',
      socialGoal: '接受指正 + 遵守規則',
      supportTip: '老師提醒行為，不等於否定你這個人。',
      hint: '被提醒時，最重要是停止違規行為，簡短回應，再改正。',
      calmPrompt: '心裡說：「我可以改返，唔需要頂嘴。」',
      steps: [
        {
          prompt: '第 1 題：被老師提醒後，第一步最好是？',
          options: [
        ...
        {
          prompt: '第 3 題：如果你不明白自己錯在哪裡，可以怎樣做？',
          options: [
